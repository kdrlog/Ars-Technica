...
public class CreativeTabRegistry {
        ...
        public static final DeferredRegister<CreativeModeTab> TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, ArsTechnicaMod.MODID);
        public static final RegistryObject<CreativeModeTab> ARS_TECHNICA_TAB = TABS.register("general", () -> CreativeModeTab.builder()
                ...
                .displayItems((params, output) -> {
                    for (ItemEntry<? extends Item> item : ItemsRegistry.ALL_ITEMS) {
